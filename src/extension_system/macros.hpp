...
#define _EXTENSION_SYSTEM_STR_HELPER(x) #x
#define _EXTENSION_SYSTEM_MACRO_EXPANSION_HELPER(x) x

#define EXTENSION_SYSTEM_STR(x) _EXTENSION_SYSTEM_STR_HELPER(x)
...
#define EXTENSION_SYSTEM_CONCAT(a,b) EXTENSION_SYSTEM_CONCAT_HELPER1(_EXTENSION_SYSTEM_MACRO_EXPANSION_HELPER(a),_EXTENSION_SYSTEM_MACRO_EXPANSION_HELPER(b))
...
#define EXTENSION_SYSTEM_COMPILER_STR_MINGW "mingw"
...
// compiler detection
	...
	#define EXTENSION_SYSTEM_FUNCTION_NAME __PRETTY_FUNCTION__
		...
		#define EXTENSION_SYSTEM_COMPILER EXTENSION_SYSTEM_COMPILER_STR_MINGW
